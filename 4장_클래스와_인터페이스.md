...
- 골격 구현 클래스는 타입을 인터페이스로 정의하고 있습니다. 그리고 130 페이지의 첫 문단, 마지막 문장에서 `인터페이스가 ... 잘 지킨 클래스라면 다른 어떤 클래스를 상속했든 같은 타입으로 취급된다.`라고 하고 있습니다. 이런 내용을 보고 생각했을 때 단일 상속만 지원함으로써 생기는 계층구조를 말하는 것이 아닐까 싶습니다만 잘은 모르겠네요.. 
## 아이템 21
